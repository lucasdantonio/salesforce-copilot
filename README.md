...
| Shared scripts | `.github/scripts/salesforce/` | PowerShell modules used by several bundled skills |
| Docs | `docs/` | Installation, structure, migration, and inventory guidance |
...
3. Copy `.github/scripts/salesforce/` as well if you use skills that rely on shared PowerShell modules.
